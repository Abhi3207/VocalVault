...
from rag.audio_processor import load_audio, chunk_audio
...
class AudioRAGPipeline:
    ...
    def ingest(self, audio_path: str | Path) -> dict:
        """
        ...
        Returns
        -------
        dict with keys: file, segments, seconds
        """
        ...
        if not segments:
            ...
            return {"file": audio_path.name, "segments": 0, "seconds": 0.0}
